# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in crud.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': crud.model,
    'DBSession': crud.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "59bdae78-60c8-428a-b258-5842d089d346",
